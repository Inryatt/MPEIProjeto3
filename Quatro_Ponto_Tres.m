...
users = unique(u(:,1));
% Extrai os IDs dos utilizadores
Nu=length(users);
% Número de utilizadores% Constrói a lista de filmes para cada utilizador
Set= cell(Nu,1);
% Usa células
for n = 1:Nu
...
%% Calcula a distˆancia de Jaccard entre todos os pares pela definic ̧ ̃ao.
...
%4distˆancia inferior a um limiar pr ́e-definido
